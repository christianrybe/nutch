...
public class WebPage extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
  ...
  /** The host part of the URL of the website. */
   ...
   * The host part of the URL of the website.   * @param value the value to set.
   */
  ...
  /**
   * Checks the dirty status of the 'host' field. A field is dirty if it represents a change that has not yet been written to the database.
   * The host part of the URL of the website.   * @param value the value to set.
   */
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WebPage>
    ...
    private Builder(org.apache.nutch.storage.WebPage other) {
      ...
      if (isValidValue(fields()[24], other.host)) {
        this.host = (java.lang.CharSequence) data().deepCopy(fields()[24].schema(), other.host);
